...
import HeroSearch from "@/app/component/HeroSearch";
      ...
      <section id="popular-jobs" className="max-w-6xl px-6 py-16 mx-auto">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {popularJobs.length === 0 ? (
            <p className="text-center col-span-full text-slate-600">No jobs posted yet.</p>
          ) : (
            popularJobs.map((job) => (
              <div key={job.id} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm transition hover:-translate-y-1 hover:shadow-lg">
